...
if([message objectForKey:@"notificationType"]){
    ...
    if([[message objectForKey:@"notificationType"] isEqualToString:@"errorCheckingUpdates"]){
    	...
    	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:NSLocalizedBundleString(@"ERROR_CHECKING_UPDATES_TITLE", nil)]
                          message:[NSString stringWithFormat:NSLocalizedBundleString(@"ERROR_CHECKING_UPDATES_BODY", nil), [moduleDict objectForKey:@"displayName"]]
                          delegate:nil 
    ...
    if([[message objectForKey:@"notificationType"] isEqualToString:@"installerNotification"]){
    	handledMessage = TRUE;
    	[self.viewController installScreenRequestedClose];
    	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:NSLocalizedBundleString(@"INSTALLER_UPDATE_TITLE", nil)]
                          message:[NSString stringWithFormat:NSLocalizedBundleString(@"INSTALLER_UPDATE_BODY", nil), [onlineModuleDict objectForKey:@"requiredInstallerVersion"]]
                          delegate:nil 
                          cancelButtonTitle:NSLocalizedBundleString(@"POPUP_ALERT_CLOSE", nil)
                          otherButtonTitles:nil];
...
if(!handledMessage){
	  UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:NSLocalizedBundleString(@"UNHANDLED_MESSAGE_TITLE", nil), [moduleDict objectForKey:@"displayName"]]
