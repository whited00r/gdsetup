...
@class ModuleViewController, SetupOTAInstallView; //Ahhhh... Class can be used instead of #import when there are circular dependancies. Makes sense now I guess. 
...
@property (nonatomic, assign) SetupOTAInstallView *setupInstallController;
