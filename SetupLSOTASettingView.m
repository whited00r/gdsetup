...
-(id)initWithFrame:(CGRect)frame{
	...
	if(self){
		...
		titleLabel = [[UILabel alloc] initWithFrame:CGRectMake((frame.size.width / 2) - 160,0, 320, 40)];
		titleLabel.textAlignment = UITextAlignmentCenter;
		[titleLabel setFont:[UIFont fontWithName:@"Verdana-Bold" size:24]];
	    ...
	    otaGroupImage.image = [UIImage imageNamed:@"UpdateGroupNoChoice.png"];
...
-(void)stablePressed{
	[UIView transitionWithView:otaGroupImage
                ...
                animations:^{
                  otaGroupImage.image = [UIImage imageNamed:@"StableLogo.png"];
                } completion:nil];
...
[UIView transitionWithView:otaGroupImage
                  duration:0.4f
                   options:UIViewAnimationOptionTransitionCrossDissolve
                animations:^{
                  otaGroupImage.image = [UIImage imageNamed:@"UnstableLogo.png"];
                } completion:nil];
